...
import { persist } from "zustand/middleware"; // to persist the store in local storage
...
// now we have access to cart, cartopen, setcartopen, addtocart and ... anywhere in your application
