...
const Products = ({ variants }: ProductTypes) => {
  return (
    <main className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7 ">
      {variants.map((variant) => (
        ...
        >
          <div className="bg-[#F7F7F7]  rounded-md flex items-center justify-center group overflow-hidden">
            <Image
              className="object-cover my-5 transition-transform duration-300 ease-in-out group-hover:scale-125"
